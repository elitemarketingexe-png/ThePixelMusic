...
/**
 * Persistent state for an app-private copy of an offline downloaded track.
 *
 * [sourceUri] remains the canonical identity (for example `youtube://abc`). The player can
 * resolve an existing queue item to [localPath] without rewriting the library row.
 */
@Entity(
